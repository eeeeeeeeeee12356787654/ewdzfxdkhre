...
function unlockDysonResearch(){
	if(getResource(RESOURCE.Energy) >= 10 && getResource(RESOURCE.Plasma) >= 10){
		Game.resources.takeResource(RESOURCE.Energy, 10);
		Game.resources.takeResource(RESOURCE.Plasma, 10);
